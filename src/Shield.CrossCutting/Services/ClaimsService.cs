...
/// <summary>
/// Implementation of the claims service interface.
/// </summary>
public class ClaimsService : IClaimsService
{
    ...
    public async Task SignInAsync(HttpContext httpContext, string userName, string token, bool isPersistent = false)
    {
        List<Claim> claims =
        [
    ...
    /// <returns>A task that represents the asynchronous operation.</returns>
    public async Task SignOutAsync(HttpContext httpContext, string? schemes)
    {
